...
\begin{definition}{$E_8$-lattice, Definition 1}\label{E8_Set}\lean{E8.E8_Set}\leanok
...
\begin{definition}{$E_8$-lattice, Definition 2}\label{E8_Basis_Vecs}\lean{E8.E8_Matrix}\leanok
...
\subsection{Properties of $E_8$ lattice}

In this section, we establish properties of the $E_8$ lattice and the $\B_8$ vectors.
