...
\begin{lemma}\label{instLatticeE8}\lean{instLatticeE8}\uses{E8_Normalised_Lattice, instDiscreteE8NormalisedSet}\leanok
...
Our main result is
\begin{theorem}\label{Main}\uses{E8_Normalised_Lattice, SpherePacking.Constant, SpherePacking.Density}
\lean{SpherePacking.Main}
