...
\begin{definition}\label{def: Sphere Packing}\lean{SpherePacking.isPacking}\leanok
...
\begin{definition}\label{def: Lattice Packing}\uses{EuclideanLattice.is_lattice}\lean{SpherePacking.isLatticePacking}\leanok
  If $X$ is a lattice in $\R^d$ then we say that $\mathcal{P}$ is a \emph{lattice sphere packing}.
\end{definition}

\begin{definition}\label{def: finite density}\lean{SpherePacking.FiniteDensity}\leanok
...
\begin{definition}\label{def: density}\uses{SpherePacking.FiniteDensity}\lean{SpherePacking.Density}\leanok
...
\begin{definition}\label{def: Sphere Packing Constant}\uses{SpherePacking.isPacking, SpherePacking.Density}\lean{SpherePacking.Constant}\leanok
