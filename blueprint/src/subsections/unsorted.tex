...
\end{proposition}
\begin{proof}
We denote the right hand side of \eqref{eqn: a double zeroes} by $d(r)$.    It is easy to see that $d(r)$ is well-defined. Indeed, from the transformation formula \eqref{eqn:phi0-trans-S} and the expansions \eqref{eqn: phi fourier0}--\eqref{eqn: phi fourier4} we obtain
\begin{align}
