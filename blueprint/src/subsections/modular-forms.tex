...
\begin{proposition}\label{prop:A_E-tsum}\uses{lemma:Ek-Fourier}\lean{A_E_eq_tsum}\leanok
...
\begin{lemma}\label{lemma:cuspform-transport-equivalences}\lean{cuspForm_Gamma_one_equiv_SL, modularForm_Gamma_one_equiv_SL}\leanok
...
\begin{lemma}\label{lemma:lv1-lv2-identities}\uses{lemma:theta-transform-S-T, lemma:theta-modular, lemma:disc-cuspform, prop:H2-fourier, prop:H3-fourier, prop:H4-fourier}\lean{SpherePacking.ModularForms.E₄_eq_thetaE4,SpherePacking.ModularForms.E₆_eq_thetaE6,Delta_eq_H₂_H₃_H₄}\leanok
We have
\begin{align}
...
\begin{proposition}\label{prop:theta-der}\uses{def:serre-der, lemma:theta-transform-S-T, lemma:jacobi-identity}\lean{serre_D_two_H₂,serre_D_two_H₄}\leanok
We have
\begin{align}
