...
\begin{theorem}\label{thm:lvl1_dims}\uses{def:holomorphic-modular-form, lemma:disc-E4E6, def:disc-definition}\leanok
...
\begin{theorem}\label{thm:dim-mf-general-level}\uses{def:Mk, thm:lvl1_dims}\leanok
...
\begin{lemma}\label{lemma:der-q-series}\uses{def:derivative}\leanok
...
\begin{proposition}\label{prop:theta-der}\uses{def:serre-der, lemma:theta-transform-S-T, lemma:jacobi-identity}\leanok
\lean{serre_D_two_H₂,serre_D_two_H₄}
% \lean{serre_D_two_H₂,serre_D_two_H₃,serre_D_two_H₄}
We have
\begin{align}
