...
\end{lemma}
\begin{proof}
  \todo{Fill in this proof, in particular the analytic properties of $H_i$.}

  We have to show that each $H_i$ satisfies property (2) of \cref{def:holomorphic-modular-form}
\end{proof}
