...
\begin{lemma}\label{lemma:E2-transform-general}\leanok\lean{EisensteinSeries.E2_slash_action}\uses{lemma:E2-transform-S, def:E2}
...
\begin{lemma}\label{lemma:der-q-series}\uses{def:derivative}\lean{D_qexp_term, D_qexp_tsum_pnat}\leanok
...
\begin{definition}\label{def:serre-der}\uses{def:derivative, def:E2}\leanok \lean{Derivative.serreDerivative}
...
\begin{theorem}
\label{thm:serre-der-equiv-action}\uses{def:serre-der, def:E2, lemma:E2-transform-general}\lean{Derivative.serreDerivative_slash_equivariant}\leanok
...
\begin{theorem}\label{thm:serre-der-modularity}\uses{def:serre-der, def:Mk, thm:serre-der-equiv-action}\lean{Derivative.serreDerivativeMF, Derivative.serreDerivative_slash_invariant}\leanok
...
\begin{theorem}\label{thm:ramanujan-formula}\uses{thm:serre-der-modularity, def:serre-der, lemma:E2-transform-general, cor:dim-mf} \lean{Derivative.normalizedDerivOfComplex_E₂, Derivative.normalizedDerivOfComplex_E₄, Derivative.normalizedDerivOfComplex_E₆, Derivative.serreDerivative_E₂, Derivative.serreDerivative_E₄, Derivative.serreDerivative_E₆} \leanok
We have
\begin{align}
...
\begin{theorem}\label{thm:serre-der-prod-rule}\uses{def:serre-der} \lean{Derivative.serreDerivative_mul} \leanok
