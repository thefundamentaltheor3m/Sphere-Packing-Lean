...
\begin{corollary}\label{cor:disc-pos}\uses{lem-disc-prodformula}
...
\begin{lemma}\label{lemma:lv1-lv2-identities}\uses{lemma-theta-transform-S-T}
We have
\begin{align}
...
\begin{lemma}\label{lemma-theta-pos}\uses{lemma-theta-functions-jacobi-identity}
...
\begin{lemma}\label{lem:der-q-series}\uses{def:derivative}
...
\begin{proposition}\label{prop:theta-der}\uses{def:serre-der}
We have
\begin{align}
