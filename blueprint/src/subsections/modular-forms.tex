...
\begin{definition}\label{def:derivative} \lean{ModularForms.Derivative.D} \leanok
...
\begin{definition}\label{def:serre-der}\uses{def:derivative, def:E2}\leanok \lean{ModularForms.Derivative.serre_D}
