...
\begin{lemma}\label{lemma:E2-transform}\uses{def:E2}\leanok\lean{E₂_transform}
...
\begin{definition}\label{def:derivative} \lean{SpherePacking.ModularForms.Derivative.D} \leanok
...
\begin{definition}\label{def:serre-der}\uses{def:derivative, def:E2}\leanok \lean{SpherePacking.ModularForms.Derivative.serre_D}
