...
\begin{theorem}\label{thm:g}\uses{thm:g1}\lean{g,g_zero,fourier_g_zero,MagicFunction.g.CohnElkies.g_nonpos_of_norm_sq_ge_two,MagicFunction.g.CohnElkies.fourier_g_nonneg}\leanok
