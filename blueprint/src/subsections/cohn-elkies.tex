...
\]
which is precisely the density of the $E_8$ packing. Note that the normalisation \eqref{eqn:g3} is what makes the factor $16$ (coming from $\widehat{f}(0) = 2^{-4}\,\widehat{g}(0)$) exactly cancel the discrepancy between $\Vol{B_8(0,1/2)}$ and the density of $E_8$; this is why an optimal $g$ must satisfy $g(0) = \widehat{g}(0)$.
