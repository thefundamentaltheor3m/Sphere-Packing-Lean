...
\end{theorem}
\begin{proof}\uses{thm:Poisson-summation-formula, periodic_constant_eq_constant, periodic_constant_eq_periodic_constant_normalized, SpherePacking.constant_eq_constant_normalized}\leanok
