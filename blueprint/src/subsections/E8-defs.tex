...
\begin{lemma}\label{E8-vector-norms}\lean{E8_integral_self}\uses{E8-defs-equivalent}\leanok
...
\begin{lemma}\label{E8Packing-covol}\lean{E8Matrix_unimodular}\uses{E8Packing}\leanok
