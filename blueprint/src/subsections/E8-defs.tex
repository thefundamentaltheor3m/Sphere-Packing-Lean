...
\begin{definition}\label{E8Packing}\lean{E8Packing}\uses{SpherePacking.Packing_of_Centres, E8_Scaled_Lattice}\leanok
  The \emph{$E_8$ sphere packing} is the sphere packing with separation $1$, whose set of centres is $\frac{1}{\sqrt{2}}\Lambda_8$.
\end{definition}

\begin{theorem}\label{E8Packing_density}\uses{E8Packing}
