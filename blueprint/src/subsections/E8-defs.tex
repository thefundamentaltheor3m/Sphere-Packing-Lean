...
\begin{definition}\label{E8-Scaled-Set}\lean{E8.E8_Scaled_Set}\uses{E8-Set}\leanok
  We define the \emph{scaled $E_8$-lattice} (by a real number $c$) as $$c\Lambda_8 = \{c \cdot \vec{v} : \vec{v} \in \Lambda_8\}$$.
\end{definition}

\begin{definition}{$E-8$-lattice, Definition 2}\label{E8-Basis-Vecs}\lean{E8.E8_Matrix}\leanok
...
\begin{definition}\label{E8-Scaled-Matrix}\lean{E8.E8_Scaled_Matrix}\uses{E8-Basis-Vecs}\leanok
...
\begin{theorem}\label{E8-defs-equivalent}\lean{E8.E8_Set_eq_span}\uses{E8-Scaled-Set, E8-Scaled-Matrix}%\leanok
...
\begin{lemma}\label{E8-Scaled-is-basis}\lean{E8.E8_Scaled_is_basis}\uses{E8-Scaled-Matrix}\leanok
...
\begin{lemma}\label{E8-Scaled-Lattice}\lean{E8.E8_Scaled_Lattice}\uses{E8-Scaled-Set, E8-defs-equivalent}\leanok
...
\begin{lemma}\label{E8-Shortest-Vector}\lean{E8.E8_norm_eq_sqrt_even}\uses{E8-defs-equivalent}\leanok
