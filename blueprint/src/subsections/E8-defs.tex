...
\begin{definition}\label{E8.E8Packing}\lean{E8.E8Packing}\uses{SpherePacking.balls, E8_Scaled_Lattice}\leanok
  The \emph{$E_8$ sphere packing} is the sphere packing with separation $1$, whose set of centres is $\frac{1}{\sqrt{2}}\Lambda_8$.
\end{definition}

\begin{theorem}\label{E8Packing_density}\uses{E8.E8Packing}
