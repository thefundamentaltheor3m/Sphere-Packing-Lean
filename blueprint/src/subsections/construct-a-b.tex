...
\begin{definition}\label{def:a-definition}\leanok
\lean{MagicFunction.a.RealIntegrals.a'}
...
\begin{definition}\label{def:b-definition}\uses{def:psiI-psiT-psiS}\leanok
\lean{MagicFunction.b.RealIntegrals.b'}
% \lean{MagicFunction.b.RealIntegrals.b',MagicFunction.b.RadialFunctions.b}
