...
\begin{definition}\label{def:a-definition}\lean{MagicFunction.a.Radial_Functions.a}\leanok
\uses{def:phi4-phi2-phi0}
...
\begin{lemma}\label{lemma:mod-div-disc-bound}\lean{DivDiscBoundOfPolyFourierCoeff}\leanok
...
\begin{proof}\uses{lemma:disc-prodformula}\leanok
