...
\end{lemma}
\todo{
Note that the assumption on the polynomial growth holds when $f$ is a modular form, where the proof can be found in \cite[p. 94]{Serre73} for the case of level 1 modular forms.
...
\uses{def:a-definition, lemma:Gaussian-Fourier, cor:phi0-bound}
...
\begin{lemma}\label{lemma:psiI-bound}\uses{lemma:psiS-bound, lemma:psiS-new, lemma:psiI-psiT-psiS-fourier}
...
\begin{proposition}\label{prop:b-double-zeros}\uses{lemma:psiI-psiT-psiS-fourier, def:psiI-psiT-psiS, cor:psiI-near-0-infty}
