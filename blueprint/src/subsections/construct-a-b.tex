...
\begin{lemma}[Smoothness of the radial profiles of $a$]\label{lemma:I-smooth}\uses{def:a-definition, thm:contDiff-integral-Ioo01, lemma:hasDerivAt-integral-IciOne}\lean{MagicFunction.a.SchwartzProperties.I₁'_smooth', MagicFunction.a.SchwartzProperties.I₂'_smooth', MagicFunction.a.SchwartzProperties.I₃'_smooth', MagicFunction.a.SchwartzProperties.I₄'_smooth', MagicFunction.a.SchwartzProperties.I₅'_smooth', MagicFunction.a.SchwartzProperties.I₆'_smooth'}\leanok
...
\begin{proposition}\label{prop:a-fourier}\uses{lemma:Ek-Fourier, def:E2, def:a-definition, lemma:Gaussian-Fourier, prop:a-schwartz, thm:perm-contour-pos}\lean{MagicFunction.a.Fourier.eig_a}\leanok
...
\begin{proposition}\label{prop:a-another-integral}\uses{prop:a-double-zeros, def:phi4-phi2-phi0, lemma:phi0-transform, def:a-definition, thm:rect-deform-tendsto-top}\lean{MagicFunction.g.CohnElkies.IntegralReps.aRadial_eq_another_integral_main}\leanok
For $r\geq0$ we have
...
\begin{proposition}\label{prop:b-fourier}\uses{def:b-definition, lemma:Gaussian-Fourier, def:psiI-psiT-psiS, prop:b-schwartz, thm:perm-contour-neg}\lean{MagicFunction.b.Fourier.eig_b}\leanok
