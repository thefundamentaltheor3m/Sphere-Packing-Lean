...
\begin{lemma}\label{lem:ineqBnew}
...
\begin{lemma}\label{lem:FGde}\uses{thm:ramanujan-formula, thm:serre-der-prod-rule, prop:theta-der, lemma:lv1-lv2-identities}
...
\begin{corollary}\label{cor:FGde}\uses{lem:FGde}
...
\begin{proposition}\label{prop:Qdec}\uses{thm:ramanujan-formula, thm:serre-der-prod-rule}
