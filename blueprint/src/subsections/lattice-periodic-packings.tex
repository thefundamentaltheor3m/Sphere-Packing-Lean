...
\begin{definition}\label{SpherePacking.PeriodicPackingCentres}\lean{SpherePacking.PeriodicPackingCentres}\uses{SpherePacking.SpherePackingCentres, IsZlattice}\leanok
