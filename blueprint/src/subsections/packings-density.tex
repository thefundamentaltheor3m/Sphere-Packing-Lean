...
\begin{theorem}\label{lemma:lattice-points-bound}\lean{PeriodicSpherePacking.aux2_ge',PeriodicSpherePacking.aux2_le'}\leanok
...
\begin{theorem}\label{lemma:periodic-points-bounds}\lean{PeriodicSpherePacking.aux2_ge',PeriodicSpherePacking.aux2_le'}\leanok
...
\begin{theorem}\label{theorem:psp-density}\uses{lemma:sp-finite-density-bound,lemma:lattice-points-bound,lemma:periodic-points-bounds,lemma:volume-ball-ratio-limit}\lean{PeriodicSpherePacking.density_eq}\leanok
