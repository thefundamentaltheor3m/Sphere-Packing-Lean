...
\begin{theorem}\label{theorem:Main}\lean{SpherePacking.MainTheorem}\uses{E8-Lattice,SpherePackingConstant,SpherePacking.density,E8Packing-density,thm:g,thm:Cohn-Elkies}
...
\end{theorem}
\begin{proof}
  Directly follows from \Cref{thm:Cohn-Elkies} applied to the function $f(x)=g(x/\sqrt{2})$ of \Cref{thm:g}.
  % TODO: Add a \ref to the actual proof at the end of this blueprint, I guess.
\end{proof}

\begin{corollary}\label{corollary:upper-bound-E8}\lean{E8.Main'}\uses{theorem:Main,periodic-packing-optimal}
...
\begin{corollary}\label{corollary:E8-optimal}\uses{corollary:upper-bound-E8}
  $\Delta_8 = \Delta_{E_8}$.
\end{corollary}
\begin{proof}
