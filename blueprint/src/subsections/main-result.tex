...
\begin{theorem}\label{theorem:CE_Main}\uses{E8-Lattice,SpherePackingConstant,SpherePacking.density,E8Packing-density,thm:g,thm:Cohn-Elkies}
...
\begin{corollary}\label{corollary:upper-bound-E8}\lean{theorem:CE_Main}\uses{theorem:Main,periodic-packing-optimal}
