...
/-!
# Tail deformation and Laplace representation for `a'`

* `I₂'_add_I₄'_add_I₆'_eq_imag_axis_tail`: rewrite `I₂' + I₄' + I₆'` via
  `Complex.rect_deform_of_tendsto_top` as an imaginary-axis integral of `Φ₅'` over `t ≥ 1`.
...
/-! ## Tail deformation (merged from `LaplaceA.TailDeformation`) -/
