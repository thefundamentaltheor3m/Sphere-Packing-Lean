...
These lemmas show that modular input functions used in the Cohn-Elkies inequalities are
real-valued along the positive imaginary axis. Main statements: `φ₀''_imag_axis_im`,
`φ₀''_imag_axis_div_im`, `ψI'_imag_axis_im`.
-/
