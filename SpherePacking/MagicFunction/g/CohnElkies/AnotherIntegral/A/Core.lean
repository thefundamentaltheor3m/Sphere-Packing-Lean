...
The integrand and integral used in the "another integral" representation of `a'`. Kept small to
avoid import cycles: analytic-continuation files can depend on these definitions without
importing the full representation proof.
-/
