...
/-!
# Identities for `Delta` in terms of `E₄`/`E₆`

This file proves `Delta z = (E₄ z ^ 3 - E₆ z ^ 2) / 1728` and reads off the second
`q`-coefficient of `Delta`.
-/

open scoped CongruenceSubgroup ArithmeticFunction.sigma
...
private lemma qExpansion_Delta_eq_smul :
  ...
  have hf : (Delta : ℍ → ℂ) =
    ...
    change _ = _ * (E₄ z * E₄ z * E₄ z - E₆ z * E₆ z); ring
...
public lemma Delta_q_exp_two : (qExpansion 1 Delta).coeff 2 = (-24 : ℂ) := by
  ...
  simp [smul_eq_mul, map_sub, pow_three, pow_two, PowerSeries.coeff_mul, hanti2, hanti1,
