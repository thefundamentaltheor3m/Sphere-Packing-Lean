...
@[blueprint
  ...
  (cz + d)^{-2} E_2\left(\frac{az + b}{cx + d}\right) = E_2(z) - \frac{6ic}{\pi (cz + d)}, \quad
  \begin{pmatrix} a & b \\ c & d\end{pmatrix} \in \mathrm{SL}_{2}(\mathbb{Z}).
  \end{equation}
  -/)
  (proof := /--
...
@[blueprint
  ...
  \end{equation}
  -/)
  (proof := /-- This is exercise 1.2.8 of \cite{first course}. -/)
  (latexEnv := "lemma")]
