...
/-- Holomorphicity of F (local version). -/
private lemma F_holo' : MDifferentiable 𝓘(ℂ) 𝓘(ℂ) F := by
...
private lemma E2sq_E4_E6_holo' : MDifferentiable 𝓘(ℂ) 𝓘(ℂ) (E₂ ^ 2 * E₄.toFun * E₆.toFun) := by
