...
The `1/2` factor is the standard normalization. -/
@[expose] public def E (k : ℤ) (hk : 3 ≤ k) : ModularForm (CongruenceSubgroup.Gamma ↑1) k :=
  (1 / 2 : ℂ) • ModularForm.eisensteinSeriesMF hk standardCongruenceCondition
...
public lemma E_k_q_expansion (k : ℕ) (hk : 3 ≤ (k : ℤ)) (hk2 : Even k) (z : ℍ) :
  ...
  change (ModularForm.E (k := k) (by exact_mod_cast hk)) z = _
