...
* `SchwartzMap.PoissonSummation.Standard` — Poisson summation over the standard `ℤ^d` lattice,
  reducing to the unit-torus Fourier series via descent and the standard Schwartz decay bound.
