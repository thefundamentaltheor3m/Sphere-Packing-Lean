...
example : 3 + I ≠ I ^ 2 := by norm_numI
example : I ^ 2 ≠ 3 := by norm_numI
example : 1 + I ≠ 0 := by norm_numI
example : 1 + I ≠ 1 + 2 * I := by norm_numI

example : re ((1 + 3 * I)⁻¹) = 0.1 := by norm_numI
example : im ((1 + 3 * I)⁻¹) = -0.3 := by norm_numI
example : 10 * re ((1 + 3 * I)⁻¹) = 1 := by norm_numI
